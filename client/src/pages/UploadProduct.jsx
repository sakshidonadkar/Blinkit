      ...
      <div className="grid p-3">
        <form className="grid gap-4" onSubmit={handleSubmit}>
          ...
          <div
            ...
            className=" hover:bg-yellow-400 bg-white py-1 px-3 w-32 text-center font-semibold border border-primary-200 hover:text-neutral-900 cursor-pointer rounded"
          >
            Add Fields
          </div>

          <button className="bg-amber-400 hover:bg-yellow-400 py-2 rounded font-semibold">
            Submit
          </button>
        </form>
      </div>
